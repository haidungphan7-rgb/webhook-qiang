...
export default defineConfig({
  ...
  // No `define` block: it used to inject __GITHUB_PROJECT_LINK__ /
  // __LATEST_RELEASE_LINK__ pointing at the UPSTREAM repository, which sent users of
  // this app to somebody else's project. Nothing in src/ referenced them (only the
  // declarations in globals.d.ts did), so they were removed instead of repointed.
  build: {
    emptyOutDir: true,
    outDir: distDir,
